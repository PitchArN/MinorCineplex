...
<html>
<head>
<title>MinorCineplex | Staff</title>
<!---------- Boothstrap ------->
...
<div class="row gx-3">
    <div class ="col">
  <label for="staffName" class="form-label">ItemName</label>
  <input type="text" class="form-control" id="staffName" name="staffName" placeholder="Item-Neme" required>
</div>
<div class="col">
  <label for="staffID" class="form-label">ItemID</label>
...
<div class="row gx-3">
<div class="col">
  <label for="staffMail" class="form-label">Price</label>
  <input type="number" class="form-control" id="staffMail" name="staffMail" required>
</div>
<div class="col">
  <label for="staffType" class="form-label">ItemType</label>
...
<div class="row gx-3">
<div class="col">
  <label for="staffMail" class="form-label">Remain</label>
  <input type="number" class="form-control" id="staffMail" name="staffMail" required>
</div>
<br>

<div class="col">
  <label for="staffPassword" class="form-label">ProID</label>
  <input type="number" class="form-control" id="staffPassword" name="staffPassword" required>
  </div>
  </div>
  <div class="col">
  <label for="staffPassword" class="form-label">Details</label>
