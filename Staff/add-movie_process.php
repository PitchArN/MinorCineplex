...
<?php 
	...
	if(isset($_POST['EditMovie'])){
		...
		$deleteAllGenre = "DELETE FROM moviegenre WHERE MovieID = '$movieID'";
		$deleteGenreQuery = mysqli_query($connect,$deleteAllGenre);
		...
		//add data to movie
      	...
      	$sql = "UPDATE movie SET MovieName='$movieName', Length='$movieLenght', Details='$movieDes', Rating= '$movieRating', RateAges='$movieRateAge', Poster='$posterURL', TrailerURL ='$trailerURL' WHERE MovieID = '$movieID'";

      	/*$sql = "INSERT INTO movie(MovieID,MovieName,Length,Details,Rating,RateAges,Poster,TrailerURL) VALUES('$row',,,,,,,)";
      	mysqli_query($connect,$sql);*/

      	//add data to genre (mapping movie with multiple genre)
      	foreach($genreToAdd as $addGenre){
      		$sql = "INSERT INTO moviegenre(movieID,genre) VALUES('$movieID','$addGenre')";
      		mysqli_query($connect,$sql);
      	}
