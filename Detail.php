    ...
    <main>
      <div class="container py-4">
        ...
        <div class="p-5 mb-4 bg-light rounded-3">
          ...
          <img src = "https://s.onlineoops.com/upload3/2/20190621/0bcd6398af08473d060d36352ce2035f.jpg" alt = "X-MEN" width="30%" height="450"><rect width="100%" height="100%" fill="#55595c"></rect></img>
            <h1 class="display-5 fw-bold"  >X-MEN</h1>
